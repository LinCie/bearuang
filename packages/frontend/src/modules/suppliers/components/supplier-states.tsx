...
export function SupplierLoadingState({
  message = 'Beruang sedang mencari pemasok...',
}: SupplierLoadingStateProps) {
  return (
...
export function SupplierErrorState({ onRetry }: SupplierErrorStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-20 animate-in fade-in duration-500">
      ...
      <p className="text-destructive/90 text-sm md:text-base text-center max-w-sm px-4 leading-relaxed mb-6">
        Aduh, sepertinya beruang kami kesasar. Pemasok ini tidak dapat ditemukan
        saat ini.
      </p>
