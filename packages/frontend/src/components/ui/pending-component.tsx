    ...
    >
      ...
      >
        ...
        <div className="flex gap-2">
          <div className="h-12 w-16 rounded-xl bg-orange-900/5 dark:bg-orange-100/5 animate-breathe" style={{ animationDelay: '0ms' }} />
          <div className="h-12 w-32 rounded-xl bg-orange-900/5 dark:bg-orange-100/5 animate-breathe" style={{ animationDelay: '200ms' }} />
          <div className="h-12 w-12 rounded-xl bg-orange-900/5 dark:bg-orange-100/5 animate-breathe" style={{ animationDelay: '400ms' }} />
        </div>
      </div>
