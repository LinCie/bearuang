...
Use serena_read_memory with memory_name="ai/requirements" to read requirements
Use serena_read_memory with memory_name="ai/data-sources" to read data source info

# Check existing data pipeline and model infrastructure
Use serena_search_for_pattern with paths_include_glob="data/**/*" to verify data directory structure
Use serena_search_for_pattern with substring_pattern="model|ml|ai" and paths_include_glob="ai/memory-bank/*.md" to find ML/AI references
```
